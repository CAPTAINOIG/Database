  ...
  return (
    ...
    <div className="row">
        ...
        <div className="col-lg-5 col-md-10 col-sm-12">
           ...
           <p class="fs-5">We focus on quality teaching, learning and <br/> training to the globally acceptable productivity <br /> standard in accordance with the requirements of <br /> the industry, for which necessary research and <br /> preparation of courses are ensured to make <br /> industry-ready professionals.</p>
...
<div className="col-lg-6">
    <div id="card2" className="card w-100">
        ...
        <div class="card-body">
          <h1 class="card-title">Data Science & Analysis</h1>
          <p class="card-text">The eruption of data is transforming indiviuals and businesses. Companies either big or small are now expecting their business decisions to be based on data-led insight.</p>
