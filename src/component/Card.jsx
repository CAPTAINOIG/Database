      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-lg-5 col-md-10 col-sm-12">
            ...
            <p className="fs-5"> Captain College of ICT is closely watching the <br /> interaction of industry and academia, getting <br /> feedback from our industry partners to provide <br /> the needed training while concentrating to <br /> contribute industry needed professionals in a very <br /> flexible study structure.</p>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-6">
            ...
            <div className="card mt-5 w-100 shadow">
          ...
          <div className="col-lg-6">
            <div id="card2" className="card w-100 shadow">
      ...
      <div className="container">
        ...
        <div className="col-lg-6">
          ...
          <div className="col-lg-6">
            ...
            <div className="card mt-5 w-100 shadow mb-5">
              <img src={software} class="card-img-top" alt="..." />
